...
var SubChunk = require('./subchunk');
var Vec3 = require('vec3');

var BIOME_ID_SIZE = 256;
var HEIGHT_SIZE = 256 * 2;

var BUFFER_SIZE = BIOME_ID_SIZE + HEIGHT_SIZE;
...
var Chunk = function () {
  ...
  _createClass(Chunk, [{
    ...
    key: 'setHeight',
    value: function setHeight(pos, height) {
      this.data.writeUInt8(height, (pos.z << 4) + pos.x);
    }
  }, {
    key: 'load',
    value: function load(newData) {
...
//# sourceMappingURL=../../maps/pe/1.0/chunk.js.map
